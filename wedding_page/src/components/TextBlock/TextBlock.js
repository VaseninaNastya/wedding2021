        ...
        <div className={s.mainInfo}>
          ...
          >
            ...
            <p className={s.infoForBikers_text}>
              ...
              <p>
                ждем тебя на Финляндском вокзале, в 11.30. Велосипеды приветствуются! <br />
                Мы очень надеемся, что погода не подведет, и получится прокатиться на велике от станции до места праздника - примерно 8 км.
                Дорога красивая и ровная, траффик спокойный. <br />
                Если не хочется кататься на велосипеде - у станции можно взять такси, либо заказать его в электричке. Телефоны таксистов:{" "}
                <a href="tel:8-921-928-72-30">8-921-928-72-30</a> или <a href="tel:8-911-252-88-20">8-911-252-88-20</a>. Тем, кто планирует
                ехать на электричке, предлагаем подписаться на &nbsp;
