        ...
        {this.state.formSended ? (
          <>
            <p className = "formSended_text">
              Ваши ответы записан! Если ответ на какой-то из вопросов изменился
              - можете отправить ответы заново. Будет учтен последний вариант
              ответов. Для того, чтобы заново ответить - обновите страницу или
              нажмите на кнопку ниже. Если что-то поменяется меньше чем за две
              недели до мероприятия - лучше напишите лично Коле или Насте.
            </p>
            <button
